...
)
{
    ...
    if (docSnap.exists()) {
        ...
        for (let e = 0; e < 11; e++) {
            if (docData[e]){
                ...
                if (free >= 0) {
                    ...
                    console.log("Seeting docData[free]")
                } else {
                    docData[e] = toAddress;
                }
        ...
        //     if (docData[2] == "Free") {
        //         console.log("Free Slot Found! (2) Updating Contacts List");
        //         docData[2] = toAddress;
        //         await setDoc(docRef, docData);
        //         await checkRecivingInbox(toAddress, userAddress, db);
        //         await SendMessage(userAddress, toAddress, message, updateToChatRoom, setNewMessage, setMessage);
